...
- Mobile hero spacing polish (Codi's iPhone 17): h1 +40px / subtitle +30px bottom space, CTA optically centered between USPs and carousel (height-responsive margin), logos sit lower so the strip balances around Safari's URL bar. *(live)*
