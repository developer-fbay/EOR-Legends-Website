...
- A/B delivery test submitted 13:26 UK: form 26 entry 6929 (old Zap's own form) and form 29 entry 6930 (live-site path). Codi to check Zap histories: new header Zap should show 6930; old "Website Inbound" Zap shows which of 6929/6930 arrived → tells us if cloned feeds deliver at all. If they don't, footer/popup need the same manual Zap hookup as the header (then delete the cloned feeds).
